...
public class ProcessUtils {
    ...
    public static long select(boolean v) throws InputMismatchException {
    ...
    private static Map<Long, String> listProcessByJps(boolean v) {
        ...
        for (String line : lines) {
            ...
            try {
                ...
                if (strings.length >= 2 && isJetbrainsProcess(strings[1])) { // skip jetbrains
                    continue;
                }
    ...
    public static void startConsoleCore(long targetPid, List<String> attachArgs) {
        ...
        // "${JAVA_HOME}"/bin/java \
        // ${opts} \
        // -jar "${console_lib_dir}/console-core.jar" \
        // -pid ${TARGET_PID}
    ...
    private static boolean isJetbrainsProcess(String mainClassName) {
        return mainClassName.contains("intellij") || mainClassName.contains("jetbrains");
    }
}
